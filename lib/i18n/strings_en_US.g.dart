...
class _Translations$realSr$en_US extends Translations$realSr$zh_CN {
	...
	@override String get remoteAutoConnect => 'Auto-connect';
	@override String get remoteAutoConnectSubtitle => 'Re-find your PC on the LAN when the connection drops';
	@override String get remoteDiscover => 'Auto-discover';
	@override String get remoteDiscoverSubtitle => 'Search the local network for a running server';
	@override String get remoteDiscoverAction => 'Search';
	@override String get remoteDiscoverTitle => 'Servers on your LAN';
	@override String get remoteDiscoverScanning => 'Searching your local network…';
	@override String remoteDiscoverProgress({required Object done, required Object total}) => 'Probed ${done} of ${total} addresses';
	@override String get remoteDiscoverNone => 'No server found';
	@override String get remoteDiscoverNoneHint => 'Check that the upscale service is running on your PC, that your phone and PC are on the same network, and that Windows Firewall allows ports 8765 (TCP) and 8766 (UDP). You can also set the address manually via Server Settings.';
	@override String remoteDiscoverFound({required Object count}) => 'Found ${count} server(s)';
	@override String get remoteDiscoverViaUdp => 'via broadcast';
	@override String get remoteDiscoverViaScan => 'via scan';
	@override String get remoteDiscoverAuthRequired => 'Token required';
	@override String remoteDiscoverPaired({required Object name}) => 'Connected to ${name}';
	@override String get remoteDiscoverTokenHint => 'This server requires auth; enter the value of MJN_API_KEY from your PC';
	@override String get lanAccess => 'Allow LAN access';
	@override String get lanAccessSubtitle => 'Let phones and tablets on the same network use this PC for upscaling (other devices on that network will be able to submit jobs too)';
	@override String get lanPhoneAddress => 'Address for your phone';
	@override String get lanCopy => 'Copy';
	@override String get lanCopied => 'Address copied';
	@override String get lanProbing => 'Checking local network reachability…';
	@override String get lanReachable => 'Reachable on your LAN';
	@override String get lanReachableHint => 'Breeze on your phone can find this PC with Auto-discover';
	@override String get lanBlocked => 'Not reachable on your LAN';
	@override String get lanBlockedHint => 'The service is running, but its LAN address is not reachable — usually because Windows Firewall has no inbound rule for the port';
	@override String get lanFixAction => 'Allow';
	@override String get lanFixCancelled => 'Cancelled (administrator permission was not granted)';
	@override String get lanFixSuccess => 'Ports opened — your phone should connect now';
	@override String get lanFixStillBlocked => 'The rule was added but the port is still unreachable; check whether third-party security software is blocking inbound connections';
	@override String get lanServiceDown => 'Local service is not running';
	@override String get lanServiceDownHint => 'Start the service first, then check LAN reachability';
	@override String get lanNoAddress => 'No LAN address detected';
	@override String get lanNoAddressHint => 'Make sure this PC is connected to Wi-Fi or an Ethernet cable';
	@override String get lanUnknown => 'LAN reachability has not been checked yet';
...
class _Translations$download$en_US extends Translations$download$zh_CN {
	...
	@override String statusComicProgress({required Object completedChapters, required Object totalChapters, required Object currentChapterCompletedImages, required Object currentChapterTotalImages}) => 'Comic progress: ${completedChapters}/${totalChapters} chapters, current chapter: ${currentChapterCompletedImages}/${currentChapterTotalImages} pages';
	@override String statusComicProgressChaptersOnly({required Object completedChapters, required Object totalChapters}) => 'Comic progress: ${completedChapters}/${totalChapters} chapters';
...
extension on TranslationsEnUs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'realSr.remoteAutoConnect' => 'Auto-connect',
			'realSr.remoteAutoConnectSubtitle' => 'Re-find your PC on the LAN when the connection drops',
			'realSr.remoteDiscover' => 'Auto-discover',
			'realSr.remoteDiscoverSubtitle' => 'Search the local network for a running server',
			'realSr.remoteDiscoverAction' => 'Search',
			'realSr.remoteDiscoverTitle' => 'Servers on your LAN',
			'realSr.remoteDiscoverScanning' => 'Searching your local network…',
			'realSr.remoteDiscoverProgress' => ({required Object done, required Object total}) => 'Probed ${done} of ${total} addresses',
			'realSr.remoteDiscoverNone' => 'No server found',
			'realSr.remoteDiscoverNoneHint' => 'Check that the upscale service is running on your PC, that your phone and PC are on the same network, and that Windows Firewall allows ports 8765 (TCP) and 8766 (UDP). You can also set the address manually via Server Settings.',
			'realSr.remoteDiscoverFound' => ({required Object count}) => 'Found ${count} server(s)',
			'realSr.remoteDiscoverViaUdp' => 'via broadcast',
			'realSr.remoteDiscoverViaScan' => 'via scan',
			'realSr.remoteDiscoverAuthRequired' => 'Token required',
			'realSr.remoteDiscoverPaired' => ({required Object name}) => 'Connected to ${name}',
			'realSr.remoteDiscoverTokenHint' => 'This server requires auth; enter the value of MJN_API_KEY from your PC',
			'realSr.lanAccess' => 'Allow LAN access',
			'realSr.lanAccessSubtitle' => 'Let phones and tablets on the same network use this PC for upscaling (other devices on that network will be able to submit jobs too)',
			'realSr.lanPhoneAddress' => 'Address for your phone',
			'realSr.lanCopy' => 'Copy',
			'realSr.lanCopied' => 'Address copied',
			'realSr.lanProbing' => 'Checking local network reachability…',
			'realSr.lanReachable' => 'Reachable on your LAN',
			'realSr.lanReachableHint' => 'Breeze on your phone can find this PC with Auto-discover',
			'realSr.lanBlocked' => 'Not reachable on your LAN',
			'realSr.lanBlockedHint' => 'The service is running, but its LAN address is not reachable — usually because Windows Firewall has no inbound rule for the port',
			'realSr.lanFixAction' => 'Allow',
			'realSr.lanFixCancelled' => 'Cancelled (administrator permission was not granted)',
			'realSr.lanFixSuccess' => 'Ports opened — your phone should connect now',
			'realSr.lanFixStillBlocked' => 'The rule was added but the port is still unreachable; check whether third-party security software is blocking inbound connections',
			'realSr.lanServiceDown' => 'Local service is not running',
			'realSr.lanServiceDownHint' => 'Start the service first, then check LAN reachability',
			'realSr.lanNoAddress' => 'No LAN address detected',
			'realSr.lanNoAddressHint' => 'Make sure this PC is connected to Wi-Fi or an Ethernet cable',
			'realSr.lanUnknown' => 'LAN reachability has not been checked yet',
			...
			'download.statusComicProgressChaptersOnly' => ({required Object completedChapters, required Object totalChapters}) => 'Comic progress: ${completedChapters}/${totalChapters} chapters',
